...
<html>
    ...
    <body>
        ...
        <header>
            <div id="logo">
                <img src="img/perfil.jpg" alt="incanatoIT" id="imagen">
            </div>
            <div id="datos">
                <p id="encabezado">
                    <b>GROUP ANDERSON & GEAN</b><br>Av. Amazonas 1368, Tingo María - Huánuco, Perú<br>Telefono:(+51)931742904<br>Email:ventas_anderGean@gmail.com
                </p>
            </div>
            <div id="fact">
