                    ...
                    <div class="card-body">
                        <div class="form-group row border">
                            <div class="col-md-9">
                                <div class="form-group">
                                    <label for="">Cliente</label>
                                    <p style="color:blue;" v-text="cliente"></p>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <label for="">Impuesto</label>
                                <p style="color:blue;" v-text="impuesto"></p>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>Tipo Comprobante</label>
                                    <p style="color:blue;" v-text="tipo_comprobante"></p>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>Serie Comprobante</label>
                                    <p style="color:blue;" v-text="serie_comprobante"></p>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>Número Comprobante</label>
                                    <p style="color:blue;" v-text="num_comprobante"></p>
                                </div>
                            </div>
                        </div>
                        <div class="form-group row border">
                                ...
                                <table class="table table-bordered table-striped table-sm">
                                    ...
                                    <tbody v-if="arrayDetalle.length">
                                        <tr v-for="detalle in arrayDetalle" :key="detalle.id">
                                            <td style="color:blue;" v-text="detalle.articulo">
                                            </td>
                                            <td style="color:blue;" v-text="detalle.precio">
                                            </td>
                                            <td style="color:blue;" v-text="detalle.cantidad">
                                            </td>
                                            <td style="color:blue;" v-text="detalle.descuento">
                                            </td>
                                            <td style="color:blue;">
                                                {{(detalle.precio*detalle.cantidad-detalle.descuento).toFixed(2)}}
                                            </td>
